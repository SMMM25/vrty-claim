...
Separate open-source repository (this repo), submitted to Xaman as an xApp (KYC verified). Visual design matches Verity Protocol; **no shared application code** with the main Verity monorepo.
